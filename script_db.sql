...
-- Volcando estructura de base de datos para paises
CREATE DATABASE IF NOT EXISTS `paises` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `paises`;

-- Volcando estructura para tabla paises.agenda
...
-- Volcando datos para la tabla paises.agenda: 5 rows
/*!40000 ALTER TABLE `agenda` DISABLE KEYS */;
INSERT IGNORE INTO `agenda` (`id`, `fecha`, `descripcion`, `prioridad`, `estado`) VALUES
	(23, '2019-12-23', 'Examen de sociales', 4, 0),
	(22, '2019-12-29', 'Examen de educación fisica', 0, 2),
	(19, '2019-12-15', 'Examen de matemáticas', 2, 1),
	(20, '2019-12-17', 'Entregar trabajo de lengua', 1, 0),
	(21, '2019-12-18', 'Reunión de delegados', 1, 2);
/*!40000 ALTER TABLE `agenda` ENABLE KEYS */;

-- Volcando estructura para tabla paises.paises
...
-- Volcando datos para la tabla paises.paises: 241 rows
/*!40000 ALTER TABLE `paises` DISABLE KEYS */;
INSERT IGNORE INTO `paises` (`id`, `iso2`, `iso3`, `prefijo`, `nombre`, `continente`, `subcontinente`, `iso_moneda`, `nombre_moneda`) VALUES
